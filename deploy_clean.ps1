...
Write-Host "`nSPRINT 1: Project Setup and Core Structure" -ForegroundColor Magenta
...
Write-Host "`nSPRINT 2: Backend Core Development" -ForegroundColor Magenta
...
Write-Host "`nSPRINT 3: Quran Features and Data Integration" -ForegroundColor Magenta  
...
Write-Host "`nSPRINT 4: Hadith System and Mobile App" -ForegroundColor Magenta
...
Write-Host "`nSPRINT 5: Final Features and Documentation" -ForegroundColor Magenta
Write-Host "2025-01-19 to 2025-03-02" -ForegroundColor Blue
...
Write-Host "`nPushing to repository..." -ForegroundColor Magenta
if ($DryRun) {
...
Write-Host "`nDeployment completed!" -ForegroundColor Magenta
